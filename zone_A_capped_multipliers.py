...
# Import all datasets
training_data = pd.read_csv("capped_global_training_dataset_zone_A.csv")
live_demo = pd.read_csv("C:/Users/nanao/Sumo/Live Demo/zone_A_5min.csv")
...
joblib.dump(model, "zone_A_mlp_tf_rl.pkl")
joblib.dump(scaler_X, "zone_A_scaler_tf_rl.pkl")
...
#live_output_df.to_csv('LPG_for_live_demo_zone_A.csv', index=False)
